...
import SortDrawerNavigator from '../SortDrawerNavigator';
...
return (
      ...
      >
        ...
        <Tab.Screen options={{ headerShown:false}} name={journalName} component={SortDrawerNavigator} initialParams={userInfo} />
