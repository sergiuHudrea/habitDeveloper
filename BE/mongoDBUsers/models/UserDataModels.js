...
exports.saveNewUser = (username, email, password) =>{
    ...
    const nUser = new User({
        ...
        challenges: { 
            ...
            Sl_4_NoCoffe8hBeforeBed: {times: null, dates:[], streak: 0, badges: [0, 0, 0], title: "Avoid caffeine 8-10 hours before bed", description: "Caffeine is a stimulate that stays in your system for hours and can affect your sleep. Avoiding consuming any caffeinated products 8-10 hours before your scheduled bedtime.", img_url: "https://i.ibb.co/kq1L7DS/no-coffee-icon.png%22"},
            Sl_5_NoLargeMealsBB: {times: null, dates:[], streak: 0, badges: [0, 0, 0], title: "No large meals and beverages in the evening", description: "Heavy meals before bed can cause digestive issues which interferes with sleep. You can have light snacks before bed. Also, drinking too many fluids can cause frequent awakening to urinate.", img_url: "https://cdn-icons-png.flaticon.com/512/1517/1517798.png"},
            Sl_6_NoAlcoholBB: {times: null, dates:[], streak: 0, badges: [0, 0, 0], title: "Avoid alcoholic drinks in the evening", description: "The presence of alcohol in the body can reduce your REM sleep, keeping you in the lighter stages of sleep. If you really enjoy a nightcap, try to limit it to one drink at least an hour before bed.", img_url: "https://i.ibb.co/JzgbpFd/no-alcohol-icon.png%22"},
