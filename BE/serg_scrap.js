...
db.Users.aggregate( [
  ...
  db.Users.insert({
    ...
    challenges: { 
                  ...
                  Sl_4_NoCoffe8hBeforeBed: {times: 8, dates:[], streak: 0, badges: [0, 0, 0], title: "Avoid caffeine 8-10 hours before bed", description: "Caffeine is a stimulant that stays in your system for hours and can affect your sleep. Avoiding consuming any caffeinated products 8-10 hours before your scheduled bedtime.", img_url: "https://i.ibb.co/kq1L7DS/no-coffee-icon.png%22"},
