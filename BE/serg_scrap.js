...
db.Users.aggregate( [
  ...
  db.Users.insert({
    ...
    challenges: { 
                  ...
                  Sl_3_RegularSleep: {times: 2, dates:[], streak: 0, badges: [], title: "Stick to a schedule", description: "Establish a sleeping schedule with at least 7 hours of sleep and, then attempt to keep the same bedtime and wake up time every day. It`s alright to have variations within one hour of planned schedule.", img_url: "https://i.ibb.co/4mFDK43/regular-Sleepicon.png%22"},
                  Sl_4_NoCoffe8hBeforeBed: {times: 8, dates:[], streak: 0, badges: [], title: "Avoid caffeine 8-10 hours before bed", description: "Caffeine is a stimulate that stays in your system for hours and can affect your sleep. Avoiding consuming any caffeinated products 8-10 hours before your scheduled bedtime.", img_url: "https://i.ibb.co/kq1L7DS/no-coffee-icon.png%22"},
                  Sl_5_NoLargeMealsBB: {times: 24, dates:[], streak: 0, badges: [], title: "No large meals and beverages in the evening", description: "Heavy meals before bed can cause digestive issues which interferes with sleep. You can have light snacks before bed. Also, drinking too many fluids can cause frequent awakening to urinate.", img_url: "https://i.ibb.co/ncZL0yW/large-meal-icon.png%22"},
                  ...
                  Sl_10_UnwindBB: {times: 44, dates:[], streak: 0, badges: [], title: "Make sure to leave time to relax before bed", description: "Make sure to have some relaxation time before bed. Mind you relaxation time does not include screen time. If you find yourself still in bed for more than 20 minutes, or you`re starting to get anxious in bed, get up and do something else until you feel sleepy.", img_url: "https://i.ibb.co/C2WJn31/relax-icon.png%22"}
                  },
    uniqueUserLink: "",
    dailyJournal: [{
